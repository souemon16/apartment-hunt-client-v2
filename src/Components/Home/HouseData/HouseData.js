...
import { faMapMarkerAlt, faBed, faBath } from '@fortawesome/free-solid-svg-icons'
        ...
        <div className="house-card">
            ...
            <div className="house-detail">
                ...
                <div className="house-capacity d-flex justify-content-around align-items-center">
                    <small> <FontAwesomeIcon icon={faBed} /> {bedrooms} Bedrooms</small>
                    <small> <FontAwesomeIcon icon={faBath} /> {bathroom} Bathroom</small>
                </div>
                <div className='d-flex justify-content-around align-items-center' >
                    <h2 className='price'>${price}</h2>
                    <Link to='/home-detail'><button className="btn view-details">View Details</button></Link>
                </div>
            </div>
        </div>
    );
